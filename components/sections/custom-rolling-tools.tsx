...
const images = [
  "/images/Product/Roller/steel-roller-01.webp",
  "/images/Product/Roller/steel-roller-02.webp",
  "/images/Product/Roller/steel-roller-03.webp",
];

export function CustomRollingTools() {
  const { t } = useLanguage();
  const dict = t.customRollingTools;

  return (
    <section
      id="custom-rolling-tools"
      className="section-padding bg-bg-primary"
      aria-label="ผลิตภัณฑ์ลูกกลิ้งรีดท่อและรีดเหล็ก"
    >
