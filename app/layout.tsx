...
export default async function RootLayout({
  ...
  const localeCookie = cookieStore.get('chp-locale')?.value
  const initialLocale = (localeCookie === 'th' || localeCookie === 'en') ? localeCookie : 'en'
